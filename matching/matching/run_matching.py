"""
Note that you need to install opencv-contrib-module to use this code
"""
...
def find_object(base, obj, result):
    # Find ORB descriptors for both base and object images
    orb = cv2.ORB_create()
    keypts_base, descr_base = orb.detectAndCompute(base["image"], None)
    keypts_obj, descr_obj = orb.detectAndCompute(obj["image"], None)
